GPU=$1
MODEL=$2
DATASETS=('FEVER-paragraph' 'FEVER-sentence' 'VitaminC' 'Climate-FEVER-paragraph' 'Climate-FEVER-sentence' 'Sci-Fact-paragraph' 'Sci-Fact-sentence' 'PUBHEALTH')
...
do
    ...
    CUDA_VISIBLE_DEVICES=${GPU} python run_glue.py \
      ...
      --test_file data/${DATASET}/dev.json \
      --max_seq_length 200 \
